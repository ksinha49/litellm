...
if _public_card.supports_authenticated_extended_card:
    try:
        ...
        logger.warning(
            ...
            exc_info=True,
        )`})}),(0,a.jsx)("div",{className:"mt-2 text-right",children:(0,a.jsx)("button",{onClick:()=>{eR(`from a2a.client import A2ACardResolver, A2AClient
...
print(response.model_dump(mode='json', exclude_none=True))`})}),(0,a.jsx)("div",{className:"mt-2 text-right",children:(0,a.jsx)("button",{onClick:()=>{eR(`client = A2AClient(
    httpx_client=httpx_client, agent_card=final_agent_card_to_use
)
...
if __name__ == "__main__":
    asyncio.run(main())`})}),(0,a.jsx)("div",{className:"mt-2 text-right",children:(0,a.jsx)("button",{onClick:()=>{eR(`# Using MCP Server with Python FastMCP
