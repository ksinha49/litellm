...
client = openai.OpenAI(
    ...
    extra_body=${e}`}let o=w.length>0?w:[{role:"user",content:C}];t=`
import base64
...
if image_data:
	...
	print(response)
`;break;case r.IMAGE_EDITS:t="azure"===$?`
import base64
import os
import time
import json
