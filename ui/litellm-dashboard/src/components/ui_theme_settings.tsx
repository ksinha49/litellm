  ...
  return (
    <div className="w-full mx-auto max-w-4xl px-6 py-8">
      <div className="mb-8">
        ...
        <Text className="text-gray-600">Customize your Ameritas LLM admin dashboard with a custom logo.</Text>
      </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <Text className="text-xs text-gray-500 mt-1">
              Enter a URL for your custom logo or leave empty to use the default Ameritas LLM logo
            </Text>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 flex items-center justify-center min-h-[120px]">
              {logoUrlInput ? (
                ...
                <Text className="text-gray-500 text-sm">Default Ameritas LLM logo will be used</Text>
              )}
            </div>
          </div>
