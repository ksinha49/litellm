      ...
      <Form form={form} onFinish={handleCreate} labelCol={{ span: 8 }} wrapperCol={{ span: 16 }} labelAlign="left">
        ...
        {selectedProvider === "pg_vector" && (
          <Alert
            ...
            description={
              <div>
                <p>Ameritas LLM provides a server to connect to PG Vector. To use this provider:</p>
        ...
        <Form.Item
          label={
            <span>
              Vector Store Name{" "}
              <Tooltip title="Custom name you want to give to the vector store, this name will be rendered on the Ameritas LLM UI">
                <InfoCircleOutlined style={{ marginLeft: "4px" }} />
              </Tooltip>
            </span>
          }
