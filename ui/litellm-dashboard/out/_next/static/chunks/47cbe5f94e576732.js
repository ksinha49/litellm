...
response = await client.send_message(request)
print(response.model_dump(mode='json', exclude_none=True))`)},className:"text-sm text-blue-600 hover:text-blue-800 cursor-pointer",children:"Copy to clipboard"})})]})]})]})}),(0,a.jsx)(d.Modal,{title:(0,a.jsxs)("div",{className:"flex items-center space-x-2",children:[(0,a.jsx)("span",{children:ek?.server_name||"MCP Server Details"}),ek&&(0,a.jsx)(g.Tooltip,{title:"Copy server name",children:(0,a.jsx)(x.Copy,{onClick:()=>eD(ek.server_name),className:"cursor-pointer text-gray-500 hover:text-blue-500 w-4 h-4"})})]}),width:1e3,open:ew,footer:null,onOk:()=>{eS(!1),eM(null)},onCancel:()=>{eS(!1),eM(null)},children:ek&&(0,a.jsxs)("div",{className:"space-y-6",children:[(0,a.jsxs)("div",{children:[(0,a.jsx)(o.Text,{className:"text-lg font-semibold mb-4",children:"Server Overview"}),(0,a.jsxs)("div",{className:"grid grid-cols-2 gap-4 mb-4",children:[(0,a.jsxs)("div",{children:[(0,a.jsx)(o.Text,{className:"font-medium",children:"Server Name:"}),(0,a.jsx)(o.Text,{children:ek.server_name})]}),(0,a.jsxs)("div",{children:[(0,a.jsx)(o.Text,{className:"font-medium",children:"Transport:"}),(0,a.jsx)(u.Tag,{color:"blue",children:ek.transport})]}),ek.alias&&(0,a.jsxs)("div",{children:[(0,a.jsx)(o.Text,{className:"font-medium",children:"Alias:"}),(0,a.jsx)(o.Text,{children:ek.alias})]}),(0,a.jsxs)("div",{children:[(0,a.jsx)(o.Text,{className:"font-medium",children:"Auth Type:"}),(0,a.jsx)(u.Tag,{color:"none"===ek.auth_type?"gray":"green",children:ek.auth_type})]}),(0,a.jsxs)("div",{className:"col-span-2",children:[(0,a.jsx)(o.Text,{className:"font-medium",children:"Description:"}),(0,a.jsx)(o.Text,{children:ek.mcp_info?.description||"-"})]}),(0,a.jsxs)("div",{className:"col-span-2",children:[(0,a.jsx)(o.Text,{className:"font-medium",children:"URL:"}),(0,a.jsxs)("a",{href:ek.url,target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:text-blue-800 text-sm break-all flex items-center space-x-2",children:[(0,a.jsx)("span",{children:ek.url}),(0,a.jsx)(r.ExternalLinkIcon,{className:"w-4 h-4"})]})]})]})]}),ek.mcp_info&&Object.keys(ek.mcp_info).length>0&&(0,a.jsxs)("div",{children:[(0,a.jsx)(o.Text,{className:"text-lg font-semibold mb-4",children:"Additional Information"}),(0,a.jsx)("div",{className:"bg-gray-50 p-4 rounded-lg",children:(0,a.jsx)("pre",{className:"text-xs overflow-x-auto",children:JSON.stringify(ek.mcp_info,null,2)})})]}),(0,a.jsxs)("div",{children:[(0,a.jsx)(o.Text,{className:"text-lg font-semibold mb-4",children:"Usage Example"}),(0,a.jsx)("div",{className:"bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto",children:(0,a.jsx)("pre",{className:"text-sm",children:`# Using MCP Server with Python FastMCP
